...
export class TestResources {
    ...
    async handleTestReportResource(uri, params) {
        try {
    ...
    async handleLatestTestReportResource(uri) {
        try {
    ...
    async handleTestReportsListResource(uri, params) {
        try {
            const filter = {
    ...
    async handleLintReportResource(uri, params) {
        try {
            const reportId = params.reportId;
            if (!reportId) {
                throw new Error("Missing required parameter: reportId");
    ...
    async handleLatestLintReportResource(uri) {
        try {
